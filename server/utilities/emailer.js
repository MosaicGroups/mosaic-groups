...
exports.sendDistinctMembersReport = function (currUser, callback) {
  ...
  reportGenerator.generateDistinctUsersReport(Group, function (report) {
    ...
    sendEmail("jeffreysklassen@gmail.com, agnes@mosaicchristian.org", "Distinct Members", "Here is your distinct members report.", attachments, callback);
  });
